...
public class HealSlime : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (anim.GetBool("isHeal") == true && anim.GetCurrentAnimatorStateInfo(0).IsName("HealSlimeSkill") &&
    ...
    void Heal()
    {
        ...
        GameObject healcollision = Instantiate(HealCollision);
        Attack heal = healcollision.GetComponent<Attack>();
        heal.damage = 10f;
        healcollision.transform.position = transform.position;
    }
