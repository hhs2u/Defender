...
public class GoblinMage : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (anim.GetCurrentAnimatorStateInfo(0).IsName("GoblinMageSkill") &&
    ...
    void Skill_Shield()
    {
        ...
        shield.transform.position = transform.position;
        Invoke("ShieldDestroy", 4f);
    }

    void ShieldDestroy()
    {
        ObjectDestroy destroyshield = shield.GetComponent<ObjectDestroy>();
        destroyshield.destroy();
    }
